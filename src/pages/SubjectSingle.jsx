...
const SubjectSingle = () => {
  const { branchSlug,subjectSlug,slug } = useParams();
  ...
  return (
    <div className="p-4">
      ...
      <p className="text-sm text-gray-500 mb-4">
        classverse / {new Date(blog.createdAt).toDateString()} / <a href={`/categories/${branchSlug}/${subjectSlug}`} className="text-amber-300">{subjectSlug}</a> / <a href={`/branch/${branchSlug}`} className="text-amber-300">{branchSlug}</a>
      </p>
